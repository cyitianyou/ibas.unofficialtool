    ...
    export namespace ui {
        export namespace c {
            ...
            export class PrivilegeConfigView extends ibas.BOQueryViewWithPanel implements app.IPrivilegeConfigView {
                        ...
                        footer: new sap.m.Toolbar("", {
                            content: [
                                ...
                                new sap.m.Button("", {
                                    ...
                                    icon: "sap-icon://edit",
                                    press: function (): void {
                                        let role: initialfantasy.bo.IRole = that.tableRoles.getSelecteds<initialfantasy.bo.IRole>().firstOrDefault();
                ...
                private tablePrivileges: sap.ui.table.TreeTable;
                private selectPlatforms: sap.m.Select;
                private fireFetchPrivilegesEvent(): void {
                    let role: initialfantasy.bo.IRole = this.tableRoles.getSelecteds<initialfantasy.bo.IRole>().firstOrDefault();
                    if (!ibas.objects.isNull(role)) {
                        let criteria: ibas.ICriteria = new ibas.Criteria();
                        let condition: ibas.ICondition = criteria.conditions.create();
                        condition.alias = initialfantasy.bo.Privilege.PROPERTY_PLATFORMID_NAME;
