package org.colorcoding.ibas.unofficialtool.bo.example;
...
import org.colorcoding.ibas.unofficialtool.MyConfiguration;
...
public class Example extends BusinessObject<Example> implements IExample {
     ...
     * 序列化版本标记
     */
    private static final long serialVersionUID = -4584268396045072199L;
    ...
    * 数据库表
    */
    public static final String DB_TABLE_NAME = "AVA_UT_EXLE";

    /**
    * 业务对象编码
    */
    public static final String BUSINESS_OBJECT_CODE = "AVA_UT_EXAMPLE";
